...
def identify_secondary_objects_iw(input_label_image=None,input_image=None,
    ...
    if input_image.dtype != np.integer:
    ...
    output_label_image = jtlib.segment_secondary(input_image,input_label_image,
                                                input_label_image,
                                                correction_factors,
